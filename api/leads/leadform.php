							...
							<div role="tabpanel" class="tab-pane" id="history">
								...
								<div class="ibox float-e-margins">
									...
									<div id="recordingDiv" class="ibox float-e-margins">
										...
										<div class="ibox-content" id="notesItem_2">
										<table class="table table-bordered table-striped">
										   	...
										   	<tbody>
										   		<?php if($result['sms'] != null) : ?>
										   		<?php foreach ($result['sms'] as $item_sms) :?>
										   		<?php 
							                    	$apiObj->mongoSetCollection("user");
							                    	$sms_user = $apiObj->mongofindOne(array('_id'=> $item_sms['_createdBy']));
							                   	?>
										      	<tr> 
										         	<td><?php echo $item_sms['toNumber']?></td>
										         	<td><?php echo $item_sms['message']; ?></td>
										         	<td><?php echo date("m/d/Y",strtotime($item_sms['_timestampCreated'])); ?></td>
										         	<td><?php echo ucwords(strtolower($sms_user['firstname'].' '.$sms_user['lastname'])); ?></td>
										      	</tr>
										      	<?php endforeach; ?>
										      	<?php endif; ?>
										   </tbody>
