...
//  }
                    ?>
                    <?PHP
if ( (!empty($settings['search_fronter'])) || (!empty($settings['search_closer'])) || (!empty($_REQUEST['search_submissionErrors'])) || (!empty($settings['search_carrier'])) || (!empty($_REQUEST['search_submitToday'])) || (!empty($_REQUEST['search_pastDue'])) || (!empty($_REQUEST['search_notPaid'])) || (!empty($_REQUEST['search_noPolicyNumber'])) || (!empty($_REQUEST['search_pastDue'])) ||  (!empty($_REQUEST['search_majorMed']))  || (!empty($settings['search_status']))  ){
