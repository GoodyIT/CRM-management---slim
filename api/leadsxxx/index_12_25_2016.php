...
$app->get('/policies', function () use ($app,$settings) {
	...
	if($apiObj->userLoggedIn()){
        ...
        if( empty($result['reportsUserGroup']) && ($result['reportsState'] == "ANY" || empty($result['reportsState'])) && ($result['reportsLeadSource'] == "ANY" || empty($result['reportsLeadSource']))){
