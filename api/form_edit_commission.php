	      	...
	      	<div class=" col-sm-12 col-md-3">
	         	<div class="form-group ">
		            ...
		            <div class="row">
			            ...
			            <div class="col-xs-12 col-md-7">
			               	<input value="<?php echo $com['months'][13]['value2'] ?>" type="text" name="person_0_commission_<?php echo $index;?>_months_13_value2" id="person_0_commission_<?php echo $index;?>_months_13_value2" class="form-control ">	
			            </div>
			        </div>
	         	</div>
	      	</div>
