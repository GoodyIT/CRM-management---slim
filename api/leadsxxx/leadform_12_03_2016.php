													...
													<tbody>
														...
														<tr>
															<td class="project-title">
																<label>AIG</label>
																<br>
																<small>Get AIG Quotes</small>
															</td>
															<td class="project-actions">
																<a href="https://enrollebc.supplementalsafetynet.com/" target="_blank" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Get Quote </a>
															</td>
														</tr>
														...
														<tr >
															<td class="project-title" >
																...
																<label>Assurant Direct</label>
																<br>
																<small>Go straight to Assurant for quote</small>
															</td>
															<td class="project-actions">
                                                              <a class="btn btn-primary btn-sm" onClick="assurantLinkCreator();"><i class="fa fa-pencil"></i> Get Quote </a>
																<div style="display:none" id="assurantDirectLink">Verify State</div>
														...
														<tr>
															<td class="project-title">
																<label>HealthCare.Gov</label>
																<br>
																<small>Submit Major Medicals, make sure you use National Writing Number!</small>
															</td>
															<td class="project-actions">
																<a href="https://www.healthcare.gov/" target="_blank" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Get Quote </a>
															</td>
														</tr>
															...
															<td class="project-title">
																<label>HII</label>
																<br>
																<small>Use this link to quote HII products</small>
															</td>
															<td class="project-actions">
                                                            <a href="https://www.hiiquote.com/quote/quote_ancillary.php?Plan_ID=72&code=A10780080000016" target="_blank" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i> Supplemental</a> 
                                                            <a href="https://www.hiiquote.com/" target="_blank" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Get Quote </a>
															</td>
														</tr>
														...
														<tr>
															<td class="project-title">
																<label>IHC</label>
																<br>
																<small>Health, life, disability, dental, vision, limited benefit, hospital indemnity and medical stop-loss insurance</small>
															</td>
															<td class="project-actions">
																<a href="http://www.ihcgroup.com/" target="_blank" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Get Quote </a>
															</td>
														</tr>
														...
														<tr>
															<td class="project-title">
																...
																<br>
																<small>Life Insurance Quotes & Submissions</small>
															</td>
															<td class="project-actions">
																<a href="http://www.ihcgroup.com/" target="_blank" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Get Quote </a>
															</td>
														...
														<tr>
															<td class="project-title">
																...
																<br>
																<small>Get Medicare Over 65 Quotes</small>
															</td>
															<td class="project-actions">
																<a href="https://tools.csgactuarial.com/auth/signin?api_key=472b58f750ffe7027a46eb172d29d803e773d09701f2b42eb662edfc471518fe&portal_name=ebroker" target="_blank" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Get Quote </a>
															</td>
														</tr>

															<tr>
															<td class="project-title">
																<label>Misc Insurance</label>
																<br>
														...
														<tr>
															<td class="project-title">
																<label>P & C</label>
																<br>
																<small>Home, auto, valuable property, business, life, disability, and long term care</small>
															</td>
															<td class="project-actions">
																<a href="https://www.ezlynx.com/" target="_blank" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Get Quote</a>
															</td>
														</tr>
															...
															<td class="project-title">
																<label>SLAICO</label>
																<br>
																<small>Accident Protection Insurance, submission done by PDF</small>
															</td>
															<td class="project-actions">
																<a href="docs" target="_blank" class="btn btn-warning btn-sm"><i class="fa fa-file-pdf-o"></i> PDF Docs </a>
																<a href="http://www.slaico.com/" target="_blank" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Get Quote</a>
															</td>
														</tr>
														...
														<tr>
															<td class="project-title">
																<label>TOOLS: ASSURANT</label>
																<br>
																<small>Quote and Submission Tool</small>
															</td>
															<td class="project-actions">
																<a class="btn btn-primary btn-sm" onClick="submitAssurant();"><i class="fa fa-pencil"></i> Get Quote </a>
															</td>
														</tr>
													</tbody>
												</table>
